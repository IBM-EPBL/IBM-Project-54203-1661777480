...
data_root='C:\\Users\\PRASANTH-PC\\Desktop\\dataset\\A_Z Handwritten Data.csv'
...
np.save("C:\\Users\\PRASANTH-PC\\Downloads\\train-images-idx3-ubyte.npy",train_data)
np.save("C:\\Users\\PRASANTH-PC\\Downloads\\train-labels-idx1-ubyte (1).npy", train_labels)
np.save("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-images-idx3-ubyte (1).npy", test_data)
np.save("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-labels-idx1-ubyte (1).npy", test_labels)
...
train_data = np.load("C:\\Users\\PRASANTH-PC\\Downloads\\train-images-idx3-ubyte.npy")
test_data = np.load("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-images-idx3-ubyte (1).npy")
train_labels = np.load("C:\\Users\\PRASANTH-PC\\Downloads\\train-labels-idx1-ubyte (1).npy")
test_labels = np.load("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-labels-idx1-ubyte (1).npy")
...
best_loss_checkpoint = ModelCheckpoint(
    filepath="C:\\Users\\PRASANTH-PC\\Downloads\\t10k-images-idx3-ubyte (1).npy",
    monitor="loss",
    save_best_only=True,
...
best_val_loss_checkpoint = ModelCheckpoint(
    filepath="C:\\Users\\PRASANTH-PC\\Downloads\\t10k-labels-idx1-ubyte (1).npy",
    monitor="val_loss",
    save_best_only=True,
    save_weights_only=True,
    mode="min"
...
model.load_weights("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-labels-idx1-ubyte (1).npy")
...
def setup_panel(display):
    ...
    accuracy_region_pt1, accuracy_region_pt2 = status_regions["accs"]
    ...
    display[accuracy_region_pt1[1]:accuracy_region_pt2[1], accuracy_region_pt1[0]:accuracy_region_pt2[0]] = (0, 0, 0)
...
def predict(model, image):
    ...
    for i in range(3):
        ...
        accuracy = round(prediction[0][max_i], 1)
        if accuracy > 0:
            label = labels[max_i]
            best_predictions[label] = accuracy
...
model = load_model("C:\\Users\\PRASANTH-PC\\Downloads\\t10k-labels-idx1-ubyte (1).npy")
